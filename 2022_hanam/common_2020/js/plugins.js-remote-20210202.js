...
! function ($) {
  ...
  function _deduplicateArray(e) {
    for (var t = [], r = 0, i = e.length; r < i; r++) {
      var n = e[r]; - 1 === _$inArray(n, t) && t.push(n)
    }
    return t
  }
                ...
                c.complete = function () {
                  if (g === this) {
                    ...
                    if (E) {
                      ...
                      o || y.attr("tabindex", -1), y.focus()
                    }
                    T && t && (location.hash = t), E && !o && y.removeAttr("tabindex"), p && l()
                  }
                }, d && b.stop(d.queue, d.clearQueue, d.jumpToEnd), v && (a.scrollTop = o[u].top), m && (a.scrollLeft = o[h].left), b.animate(a, c), t.preventDefault()
              }
            })
          }
        }
...
NeoVirtualKeyboard.prototype = {
  ...
  _createKeyboard: function (a) {
    ...
    $.each(this.KEYLAYOUT[a], function (a, d) {
      0 !== a && $.each(d, function (a, c) {
        a = c[0];
        var d = c[1];
        "MULTI" === b._.keyLayoutType ? "BACKSPACE" === a ? b.$keyboardLayout.append('<li><button type="button" id="backspaceKey" class="special-event"><em class="backspace-key">backspace</em></button></li>') :
          ...
          (a = b.shiftKeyToggle ? c[1] : c[0], d = b.shiftKeyToggle ? c[0] : c[1], a === d ? b.$keyboardLayout.append('<li><button type="button"><span>' + a + "</span></button></li>") : b.$keyboardLayout.append('<li><button type="button"><span>' + a + "</span><i>" + d + "</i></button></li>")) : "SIMPLE" === b._.keyLayoutType && ("BACKSPACE" === a ? b.$keyboardLayout.append('<li><button type="button" id="backspaceKey" class="special-event"><em class="backspace-key">backspace</em></button></li>') : "TAB" === a ? b.$keyboardLayout.append('<li><button type="button" id="tabKey" class="special-event"><em class="tab-key">Tab</em></button></li>') :
            "TRANS" === a ? b.$keyboardLayout.append('<li><button type="button" id="langConversionKey" class="special-event"><em class="lang-conversion ' + ("KO" === d ? "ko" : "en") + '">ko/en</em></button></li>') : "RETURN" === a ? b.$keyboardLayout.append('<li class="absorption align-left"><button type="button" id="returnKey" class="special-event"><em class="return-key">Return</em></button></li>') : "SHIFT_LEFT" === a ? b.$keyboardLayout.append('<li class="absorption align-right"><button type="button" id="shiftLeftKey" class="special-event ' +
              ...
              c[0], b.$keyboardLayout.append('<li><button type="button"><span>' + a + "</span></button></li>")))
      })
    })
  },
  _bindEvent: function () {
    ...
    this.$neoVirtualKeyboardClose.on("click.NeoVirtualKeyboard",
      $.proxy(this.hideKeyboard, this))
  },
  ...
  _getComplexVowelIndex: function (a, b) {
    return "undefined" === typeof b ? this.HANGUL.INDEX.CV1.indexOf(a) :
      this.HANGUL.INDEX.CV2.indexOf(a + b)
  },
  isHangul: function (a) {
  ...
  _changeLayoutKey: function (a) {
    return "shiftLeftKey" === a || "shiftRightKey" === a ? (this.shiftKeyToggle = !this.shiftKeyToggle, this.changeKeyboard(this._.keyLayout), !0) : "langConversionKey" === a ? (a = this._.keyLayout, "KOREAN" === a ? a = "ENGLISH" : "ENGLISH" === a && (a = "KOREAN"),
      this.changeKeyboard(a), !0) : !1
  },
  _clickFunctionKey: function (a, b, c) {
    "shiftLeftKey" !== b && "shiftRightKey" !== b && "langConversionKey" !== b && this.$inputElement.focus();
    return "tabKey" === b ? (this._inputElementValue(a, "\t", c, !1), !0) : "backspaceKey" === b ? (this._inputElementValue(a.substring(0, a.length - 1), "", c, !1), !0) : "spaceKey" === b ? (this._inputElementValue(a, " ", c, !1), !0) : "returnKey" === b ? keyboardSubmit(a) : !1
  },
  _inputElementValue: function (a, b, c, d) {
    a = d ? a.substring(0, a.length - 1) + b : a + b;
    this.$inputElement.val(a +
      c);
    ...
    if (!this._changeLayoutKey(b) && "undefined" !== typeof this.$inputElement.val()) {
      ...
      if (!this._clickFunctionKey(a, b, e)) {
        if (this.isConsonant(g)) {
          ...
          if (b = this.splitCharIndex(f), 0 === b[2]) {
            if (this.isConsonant(d)) {
              c = this.combineChar(b[0], b[1], this.HANGUL.INDEX.F.indexOf(c));
              this._inputElementValue(a, c, e, !0);
              return
            }
            if (this.isVowel(d) && (d = this._getComplexVowelIndex(this.HANGUL.INDEX.M[b[1]], c), -1 !== d)) {
          ...
          if (d = this._getComplexConsonantIndex(this.HANGUL.INDEX.F[b[2]], c), -1 !== d) {
          ...
          "undefined" === typeof f ? (d = this.combineChar(b[0], b[1], 0), c = this.combineChar(this.HANGUL.INDEX.I.indexOf(this.HANGUL.INDEX.F[b[2]]),
            this.HANGUL.INDEX.M.indexOf(c), 0)) : (d = this.combineChar(b[0], b[1], this.HANGUL.INDEX.F.indexOf(f[0])), c = this.combineChar(this.HANGUL.INDEX.I.indexOf(f[1]), this.HANGUL.INDEX.M.indexOf(c), 0));
...
(function ($) {
  ...
  $(function () {
    ...
    var $header = $('#header'),
      ...
      lnbHeight,
      depth1ListLenght = $lnb.find('.depth1_item').length - 2;
    ...
    $lnbDepthItem.on('mouseover.menu focusin.menu', function (event) { //mouseover
      if (mode === 'pc') {
        var $this = $(this),
    ...
    $lnbMenu.on('mouseleave.menu', function (event) { //mouseleave
      if (mode === 'pc') {
        $lnbMenu.height('');
        $html.removeClass('lnb_open');
        $lnbDepthItem.removeClass('active');
