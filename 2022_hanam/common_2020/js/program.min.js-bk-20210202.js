  ...
  $(function () {
    ...
    s.prototype.change = function () {
      ...
      if ($(this.options.box).find(".p-upload").length < this.options.count) {
        ...
        a += "   <div class='p-form-group'>", a += "       <div class='p-form-group__upload'>", a += "           <input type='file' name='attachImages[]' accept='image/!*' id='" + e + "' class='p-upload__file--hidden'>", a += "           <span id='" + i + "' class='p-input disabled'></span>", a += "           <button type='button' class='p-upload__clear clear'>선택한 첨부 제거</button>", a += "       </div>", a += "       <div class='p-input__addon'>", a += "           <label for='" + e + "' class='p-button p-button--small primary' data-button='upload' data-parent='.p-upload' data-original='#" + e + "' data-showfilename='#" + i + "'>파일선택</label>", a += "           <button type='button' class='p-button gray'  onclick='removeInput(\"" + e + "\")'>제거</button>", a += "       </div>", a += "   </div>", a += '   <input type="text" id="" class="p-input" title="1번 첨부 이미지 대체 텍스트 입력" value="" placeholder="첨부 이미지 대체 텍스트 입력">', a += "</div>", $(this.options.box).append(a), $('[data-button="upload"]').each(function () {
          var t = $(this),
            e = t.data();
          o.call(t, e)
        })
