...
if (function (t, e, i) {
    ...
    C.prototype = {
      ...
      place: function () {
        ...
        if ("auto" === u && (u = -s + p - e < 0 ? "bottom" : "top"), this.picker.addClass("p-datepicker-orient-" + u), "top" === u ? p -= e + parseInt(this.picker.css("padding-top")) : p += h, this.o.rtl) {
          var f = a - (c + d);
          this.picker.css({
            top: p,
            right: f,
      ...
      fill: function () {
        ...
        if (!isNaN(s) && !isNaN(a)) {
          ...
          this._fill_yearsView(".p-datepicker-years", "year", 10, s, o, r, this.o.beforeShowYear), this._fill_yearsView(".p-datepicker-decades", "decade", 100, s, o, r, this.o.beforeShowDecade), this._fill_yearsView(".p-datepicker-centuries", "century", 1e3, s, o, r, this.o.beforeShowCentury), this.picker.find("button.disabled").attr("disabled", !0)
        }
      },
  ...
  $(function () {
    ...
    s.prototype.click = function (t) {
      ...
      s && (filename = filename + " 외 " + s + " 건"), a.addClass("active"), i.html(filename)
      ...
      if ($(this.options.box).find(".p-upload").length < this.options.count) {
        ...
        a += "   <div class='p-form-group'>", a += "       <div class='p-input__addon'>", a += "           <button type='button' class='p-button p-button--small primary' data-button='upload' data-parent='.p-upload' data-original='#" + e + "' data-showfilename='#" + i + "'>파일선택</button>", a += "       </div>", a += "       <div class='p-form-group__upload'>", a += "           <input type='file' name='attachImages[]' accept='image/!*' id='" + e + "' class='p-upload__file--hidden'>", a += "           <span id='" + i + "' class='p-input disabled'></span>", a += "           <button type='button' class='p-upload__clear clear'>선택한 첨부 제거</button>", a += "       </div>", a += "       <div class='p-input__addon padding_l_5'>", a += "           <button type='button' class='p-button gray'  onclick='removeInput(\"" + e + "\")'>제거</button>", a += "       </div>", a += "   </div>", a += '   <input type="text" id="" class="p-input" title="1번 첨부 이미지 대체 텍스트 입력" value="" placeholder="첨부 이미지 대체 텍스트 입력">', a += "</div>", $(this.options.box).append(a), $('[data-button="upload"]').each(function () {
          var t = $(this),
            e = t.data();
          o.call(t, e)
        })
