...
(function($) {
    ...
    $(function() {
        ...
        var $header = $('#header'),
            ...
            lnbHeight,
            lnbDepth1ItemLenght = $lnb.find('.depth1_item').length;

        $lnb.addClass('length' + lnbDepth1ItemLenght);
        ...
        var $container = $('#container'),
            ...
            sideDepth1ItemLenght = $side.find('.depth1_item').length;

        $side.addClass('length' + sideDepth1ItemLenght);
